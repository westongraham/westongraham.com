...
export default function ToolsPage() { return <main className="shell editorial-page tools-page"><Link className="back-link" href="/">← Weston Graham</Link><p className="section-label">Developer toolbox</p><h1>Small utilities for everyday engineering work.</h1><p className="lede">Practical, local-first tools for formatting, decoding, testing, and checking common development inputs.</p><DeveloperToolbox /></main>; }
